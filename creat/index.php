...
<p>氏名：<?php echo $user_username; ?></p>
<p>メールアドレス；<?php echo $user_email; ?></p>
<p>性別：<?php echo $user_gender; ?></p>
<p>生年月日：<?php echo $user_birth_year; ?> / <?php echo $user_birth_month; ?> / <?php echo $user_birth_day; ?></p>
<a href="logout.php?logout">ログアウト</a></br>
<a href="admin.php">管理者</a></br>
<a href="creater">クリエイタ一覧</a></br></br>
<?php
  // ユーザーIDからユーザー名を取り出す
...
?>
  ...
  while ($row = $result->fetch_assoc()) {
    ...
    // ユーザーIDからユーザー名を取り出す
    $queryy = "SELECT * FROM client_prof WHERE user_id = '$editer_id'";
