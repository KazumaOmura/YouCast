...
<main>
            ...
            <p style="margin-top:0; text-align:left; font-weight:bold;">受注履歴</p>
            <hr style="border-top: 3px solid #1E82DB !important; margin-top:-10px;">
              <?php
               $query = "SELECT * FROM order_receive WHERE editer_id = '$user_id'";
               $result = $mysqli->query($query);
                ...
                $project_name = $row['project_name'];
                 ...
                 <tr>
                    ...
                    if(!$project_name){
                      ...
                      if($project_done_flag == 0){
                        ?>
                        <td class="done_flag" rowspan="2"><p>クライアント承認待ち</p></td>
                        <?php
                      }
                      else if($project_done_flag == 1){
                        ?>
                        ...
                        ?>
                        <td class="done_flag" rowspan="2"><p>クライアント支払い待ち</p></td>
                        <?php
                      }
                      else if($project_done_flag == 3){
                        ?>
                        <td class="done_flag" rowspan="2"><p>仕事を開始してください</p></td>
                        <?php
                      }
                      else if($project_done_flag == 4){
                        ?>
                        <td class="done_flag" rowspan="2"><p>クライアント評価待ち</p></td>
                        <?php
                      }
                      else if($project_done_flag == 5){
                        ?>
